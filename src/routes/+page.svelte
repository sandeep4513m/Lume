...
>
  ...
  >
          ...
          >
            <svg
              ...
              ><rect x="3" y="5" width="6" height="6" rx="1"></rect><path
                d="m3 17 2 2 4-4"
              ></path><path d="M13 6h8"></path><path d="M13 12h8"></path><path
                d="M13 18h8"
              ></path></svg
            >
          </button>
    ...
    <div
      class="flex-1 overflow-y-auto w-full px-3 py-4 space-y-1.5 scroll-smooth relative"
    >
      {#each filteredSessions as session}
        <div
          ...
          class="group cursor-pointer flex items-center rounded-lg p-2.5 transition-all relative select-none
            ...
            {isSidebarCollapsed
            ? 'justify-center h-11 w-11 mx-auto border-none p-0'
            : ''}
        ...
        >
          {#if isSidebarCollapsed}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5 {session.id === currentSessionId
                ? 'text-emerald-500'
                : 'text-gray-400'}"
              viewBox="0 0 24 24"
              fill="none"
          ...
          {:else if isBulkSelectMode}
            ...
            <button
              ...
              class="mr-2.5 shrink-0 w-5 h-5 rounded border-2 flex items-center justify-center transition-colors {selectedSessionIds.has(
                session.id,
              )
            ...
            <div class="flex flex-col flex-1 min-w-0">
              <span
                class="text-[13px] font-medium truncate {selectedSessionIds.has(
                  session.id,
                )
                  ? 'text-emerald-700 dark:text-emerald-400'
                  : 'text-gray-700 dark:text-gray-300'}">{session.title}</span
              >
          ...
          {:else}
            <div class="flex flex-col flex-1 min-w-0 pr-14">
              ...
              <div class="flex items-center space-x-2">
                ...
                {#if getChatWordCount(session.id)}
                  ...
                  <span
                    class="text-[10px] bg-gray-100 dark:bg-gray-800 text-gray-400 dark:text-gray-500 px-1.5 py-0.5 rounded-full font-medium mt-0.5"
                    >{formatWordCount(/** @type {number} */ (wc))}w</span
                  >
                {/if}
              </div>
            </div>
            ...
            >
              ...
              <button
                ...
                class="p-1.5 rounded-md transition-all hover:bg-white dark:hover:bg-gray-800 {session.is_pinned
                  ? 'text-emerald-500'
      ...
      {#if isBulkSelectMode && selectedSessionIds.size > 0}
        <div
          class="sticky bottom-0 left-0 right-0 mx-1 bg-white dark:bg-[#161b22] border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg p-2 flex items-center justify-between"
        >
          <span
            class="text-[12px] font-medium text-gray-600 dark:text-gray-400 pl-1"
            >{selectedSessionIds.size} selected</span
          >
          <button
          ...
          >
            <svg
              ...
              stroke-linejoin="round"
              ><polyline points="3 6 5 6 21 6"></polyline><path
                d="M19 6v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"
              ></path></svg
            >
            <span>Delete</span>
          </button>
    ...
    <div
      class="p-3 border-t border-gray-200 dark:border-gray-800 shrink-0 mt-auto relative"
    >
      ...
      {#if isUserMenuOpen && !isSidebarCollapsed}
        ...
        <div
          class="absolute bottom-[calc(100%+8px)] left-3 right-3 z-50
        ...
        >
          ...
          <div class="px-4 py-3">
            <p
              class="text-[13px] font-semibold text-gray-900 dark:text-gray-100 truncate"
            >
              {userName}
            </p>
          ...
          <div class="px-1.5 pt-1 pb-1.5">
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="w-[15px] h-[15px] text-gray-400 shrink-0 group-hover:scale-110 transition-transform"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                stroke-width="2"
      ...
      {#if !isSidebarCollapsed}
        ...
        >
          ...
          <span
            class="flex-1 text-[13px] font-medium text-gray-800 dark:text-gray-200 truncate text-left"
            >{userName}</span
          >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="w-3.5 h-3.5 text-gray-400 transition-transform duration-200 {isUserMenuOpen
              ? 'rotate-180'
              : ''}"
            viewBox="0 0 24 24"
            fill="none"
                ...
                {#if !msg.isLoading && (msg.content || msg.thinkContent)}
                  ...
                  >
                    ...
                    >
                      ...
                      <button
                        onclick={() => handleRegenerate(msg, i)}
                        class="p-1.5 hover:text-emerald-500 rounded-lg transition-colors hover:bg-gray-100 dark:hover:bg-[#21262d]"
                        title="Regenerate"
                      >
                        <svg
